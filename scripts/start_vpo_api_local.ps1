...
$env:VPO_POSTGRES_APPLICATION_NAME = "vpo-corp-local"
$env:VPO_POSTGRES_POOL_MIN_SIZE = "1"
$env:VPO_POSTGRES_POOL_MAX_SIZE = "4"
$env:VPO_POSTGRES_POOL_TIMEOUT_SECONDS = "10"
$env:VPO_POSTGRES_POOL_MAX_WAITING = "16"
$env:VPO_POSTGRES_POOL_MAX_LIFETIME_SECONDS = "1800"
$env:VPO_POSTGRES_POOL_MAX_IDLE_SECONDS = "300"
