...
export async function GET(_request: NextRequest, context: RouteContext) {
  ...
  const response = await fetch(`${config.apiUrl}/booking/shows/${showId}/account`, {
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  const response = await fetch(`${config.apiUrl}/booking/shows/${showId}/account/applications`, {
    method: "POST",
    headers: {
